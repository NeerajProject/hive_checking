...
export class AvailableSlotsWizard extends Component {
...
async getFreeSlotsInofEighteenHoles(){
 ...
 await   rpc.query({
                ...
                method: 'get_free_slots_in_of_eighteen_holes',
...
AvailableSlotsWizard.props = {
    ...standardFieldProps,
};
registry.category("fields").add("AvailableSlotsWizard", AvailableSlotsWizard);
